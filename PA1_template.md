...
```
## [1] "5 minute interval with maximum no.of steps is :  835"
```
...
```
## [1] "Total no.of missing values :  2304"
```
...
```
## [1] "Mean is same as the original data set. Median differs by : 1.1886792452824"
```
